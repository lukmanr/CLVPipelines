...
You can run the solution on a full Kubeflow installation  or on a lightweight deployment that only includes core Kubeflow Pipelines services. 

To provision the full Kubeflow installation follow [the Kubeflow on GCP guide](https://www.kubeflow.org/docs/gke/deploy/).
